...
ggplot(data = tuna_kobe, aes(x = b_msy, y = f_msy, label = stockid)) +
...
ggplot(data = billfish_kobe, aes(x = b_msy, y = f_msy, label = stockid)) +
...
ggplot(data = shark_kobe, aes(x = b_msy, y = f_msy, label = stockid)) +
